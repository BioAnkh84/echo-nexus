...
def worker():
    ...
    messages = [{'role': 'system', 'content': 'You are ' + payload['persona'] +
        ...
        'An existing valid, unrevoked grant covering the action may suffice; do not require '
        'fresh approval for every task. Without applicable authority, stop and obtain it. '
